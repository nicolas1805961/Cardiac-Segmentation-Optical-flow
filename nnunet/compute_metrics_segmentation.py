...
if __name__ == "__main__":
    ...
    pred_directory = r"C:\Users\Portal\Documents\voxelmorph\segmentation\Task032_Lib\fold_0\Lib\test\Postprocessed\Registered_backward"
    ...
    for patient_name in tqdm(registered_patients):
        ...
        path_list_flow = glob(os.path.join(r'C:\Users\Portal\Documents\voxelmorph\segmentation\Task032_Lib\fold_0\Lib\test\Postprocessed\Registered_backward', patient_name, 'temp_allClasses', '*.gz'))
        flow_patient = [os.path.basename(x)[:-7] for x in path_list_flow]
        ...
        path_list = [np.array(path_list)[ed_number]]
