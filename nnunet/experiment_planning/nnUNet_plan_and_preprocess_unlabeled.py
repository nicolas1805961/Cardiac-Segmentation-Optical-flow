...
def main():
    ...
    #planner_name2d_unlabeled = args.planner2dunlabeled

    if planner_name3d == "None":
        planner_name3d = None
    if planner_name2d == "None":
        planner_name2d = None
    #if planner_name2d_unlabeled == "None":
    #    planner_name2d_unlabeled = None
    ...
    for i in task_ids:
        ...
        if '27' in task_name or '31' in task_name or '35' in task_name or '39' in task_name:
    ...
    #if planner_name2d_unlabeled is not None:
    #    planner_2d_unlabeled = recursive_find_python_class([search_in], planner_name2d_unlabeled, current_module="nnunet.experiment_planning")
    #    if planner_2d_unlabeled is None:
    #        raise RuntimeError("Could not find the Planner class %s. Make sure it is located somewhere in "
    #                           "nnunet.experiment_planning" % planner_name2d_unlabeled)
    #else:
    #    planner_2d_unlabeled = None
