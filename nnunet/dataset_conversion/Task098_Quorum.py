...
if __name__ == "__main__":
    folder = os.path.join('Quorum_split', 'train')
    folder_test = "/media/fabian/My Book/datasets/ACDC/testing/testing"
    out_folder = os.path.join('out', 'nnUNet_raw_data_base', 'nnUNet_raw_data', 'Task098_Quorum')
    ...
    save_pickle(splits, os.path.join('out', 'nnUNet_raw_data_base', 'nnUNet_raw_data', 'Task098_Quorum', 'splits_final.pkl'))