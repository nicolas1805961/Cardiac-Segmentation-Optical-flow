import torch
from acdc_dataset import create_3d_acdc_dataset
...
from training_utils import build_policy_net, build_discriminator, set_losses, set_augmentations, read_config, build_3d_model, create_loggers, count_parameters
...
img_size = 128
train_path = 'ACDC_resampled_cropped/*'
val_path = 'ACDC_resampled_cropped/*'
