...
#python run/run_training.py 2d nnMTLTrainerV2 Task029_Quorum 1 -p custom_experiment_planner --deterministic
#python run/run_training.py 2d nnMTLTrainerV2 Task030_Quorum_RV_removed 0 -p custom_experiment_planner --deterministic
#python run/run_training.py 2d nnMTLTrainerV2Video Task027_ACDC 0 -p custom_experiment_planner --deterministic
#python run/run_training.py 2d nnMTLTrainerV2 Task031_ACDC 0 -p custom_experiment_planner --deterministic
#python run/run_training.py 2d nnMTLTrainerV2 Task032_Lib 0 -p custom_experiment_planner --deterministic
#python run/run_training.py 2d nnMTLTrainerV2Augment Task032_Lib 0 -p custom_experiment_planner --deterministic
python run/run_training.py 2d nnMTLTrainerV2 Task032_Lib 0 -p custom_experiment_planner -config seg_model.yaml --deterministic