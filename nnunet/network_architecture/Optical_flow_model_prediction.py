...
class OpticalFlowModelPrediction(SegmentationNetwork):
    def __init__(self,
                deep_supervision,
                out_encoder_dims,
                in_dims,
                ...
                all_to_all,
                only_first):
        super(OpticalFlowModelPrediction, self).__init__()
        ...
        if self.only_first:
            ...
            #self.flow_seg_encoder = TransformerFlowSegEncoderIterative(dim=self.d_model, nhead=self.bottleneck_heads, nb_iters=nb_iters)
