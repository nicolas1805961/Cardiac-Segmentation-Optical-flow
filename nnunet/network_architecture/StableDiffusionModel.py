...
from nnunet.training.network_training.StableDiffusionPositionEmbedding import SinusoidalPositionEmbeddings
...
class Model(SegmentationNetwork):
    def __init__(self, dim, channels=1):
        ...
        # À compléter...
        self.time_dim = 512
        self.t_emb = SinusoidalPositionEmbeddings(self.time_dim)
        self.unet = Unet(
    ...
    def forward(self, x_t, time):
        # À compléter...
        time = self.t_emb(time)
        return self.unet(x_t, time)