...
#from nnunet.training.data_augmentation.distance_xor import DistanceXor
...
def get_moreDA_augmentation_middle(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
    ...
    #tr_transforms.append(DistanceXor(input_key1='target', input_key2='middle_target', output_key='xor'))
    ...
    if deep_supervision_scales is not None:
        ...
        if soft_ds:
            ...
            #tr_transforms.append(DownsampleSegForDSTransform3(scales, 'xor', 'xor', classes))
            ...
            #tr_transforms.append(DownsampleSegForDSTransform2(scales, 0, input_key='xor', output_key='xor'))
            tr_transforms.append(DownsampleX(deep_supervision_scales, input_key='data', output_key='data', order=3))

    #tr_transforms.append(NumpyToTensor(['data', 'target', 'middle', 'middle_target', 'middle_heatmap'], 'float'))
    ...
    #val_transforms.append(HeatMap(input_key='middle_target', output_key='middle_heatmap'))
    #val_transforms.append(DistanceXor(input_key1='target', input_key2='middle_target', output_key='xor'))

    if deep_supervision_scales is not None:
        if soft_ds:
            assert classes is not None
            val_transforms.append(DownsampleSegForDSTransform3(scales, 'target', 'target', classes))
            #val_transforms.append(DownsampleSegForDSTransform3(scales, 'xor', 'xor', classes))
            ...
            #val_transforms.append(DownsampleSegForDSTransform2(scales, 0, input_key='xor', output_key='xor'))
            val_transforms.append(DownsampleX(deep_supervision_scales, input_key='data', output_key='data', order=3))
            

    #val_transforms.append(NumpyToTensor(['data', 'target', 'middle', 'middle_target', 'middle_heatmap'], 'float'))
...
def get_moreDA_augmentation_middle_unlabeled(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
                            seeds_train=None, seeds_val=None, order_seg=1, order_data=3, deep_supervision_scales=None,
                            soft_ds=False,
                            classes=None, pin_memory=True, regions=None,
