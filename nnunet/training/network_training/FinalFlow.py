...
from nnunet.lib.training_utils import build_model_1, build_final_flow_model, build_2d_model, build_flow_model_video, build_discriminator, read_config_video, read_config, build_discriminator, build_discriminator, build_video_model
...
class FinalFlow(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = build_final_flow_model(self.config, image_size=self.crop_size, log_function=self.print_to_log_file, nb_channels=2)
